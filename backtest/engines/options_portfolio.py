...
Signal interface: signal_map is a list of trade instruction dicts.
...
def run_options_backtest(
    ...
    Args:
        ...
        data_map: dict[str, pd.DataFrame] — underlying price data.
        signal_map: list[dict] — list of trade instruction dicts.
    ...
    # Use passed-in signals
    signals = signal_map if signal_map is not None else []
